...
features and wine quality. The most interesing plot is the one that shows the
distribution of alcohol level, which shows a clear difference between different
wine qualities.
...
wine qualities. We can see that there are three clusters, green dots accumulate
at left representing low quality wines, blue dots in the center represening mid
quality wines, and red dots at right representing high quality wines.
